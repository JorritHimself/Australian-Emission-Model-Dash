...
# LULUCF make it annual removals and annual growth
# 2030 rates
###################
...
pickerlist = ['services_emis_picker1830','mining_emis_picker1830','manufacturing_emis_picker1830','gas_water_waste_emis_picker1830','construction_emis_picker1830',
'com_transp_emis_picker1830','agrifor_emis_picker1830','electricity_emis_picker1830','residential_emis_picker1830',
        ...
        return html.Div([
            dbc.Container([
                dbc.Row([
                    ...
                    dbc.Col((html.Div(html.H4('Annaul change in emissions by sector'))), width=6),
                    dbc.Col((html.Div(html.H4('Value added growth'))), width=3),
                    ]),
                dbc.Row([
                    dbc.Col((html.Div(html.H5(''))), width=3),
                    dbc.Col((html.Div(html.H5('(Mt CO2-eq per year)'))), width=6),
                    dbc.Col((html.Div(html.H5('(% annual change in 2019 AUD)'))), width=3),
                    ]),
                dbc.Row([
                    dbc.Col((html.Div(html.H5(''))), width=3),
                    dbc.Col((html.Div(html.H5('Historical'))), width=2, style={"text-align": "center"}),
                    ...
                    dbc.Col((html.Div(html.H5('Historical'))), width=2, style={"text-align": "center"}),
                    dbc.Col((html.Div(html.H5('Future'))), width=2, style={"text-align": "center"}),
                    ]),
                dbc.Row([
                    dbc.Col((html.Div(html.H5(''))), width=3),
                    dbc.Col((html.Div(html.H5('2009 to 2018'))), width=2, style={"text-align": "center"}),
                    dbc.Col((html.Div(html.H5('2019 to 2030'))), width=2, style={"text-align": "center"}),
                    dbc.Col((html.Div(html.H5('2031 to 2050'))), width=2, style={"text-align": "center"}),
                    dbc.Col((html.Div(html.H5('2009 to 2018'))), width=2, style={"text-align": "center"}),
                    dbc.Col((html.Div(html.H5('2019 to 2050'))), width=2, style={"text-align": "center"}),
                    ]),
                dbc.Row([
                    dbc.Col((html.Div(html.H4('Services'))), width=3),
                    dbc.Col((html.Div(html.H4(pickersetting_dict['services_emis_picker1830_value']))), width=2, style={'text-align': 'center'}),
                    dbc.Col((html.Div(dbc.Input(id='services_emis_picker1830', type="number", bs_size="sm", value=pickersetting_dict['services_emis_picker1830_value'], step=pickersetting_dict['services_emis_picker1830_steps']))), width=2, style={"text-align": "center", "padding-top":"0.15rem"}),
                    dbc.Col((html.Div(dbc.Input(id='services_emis_picker3150', type="number", bs_size="sm", value=pickersetting_dict['services_emis_picker1830_value'], step=pickersetting_dict['services_emis_picker1830_steps']))), width=2, style={"text-align": "center", "padding-top":"0.15rem"}),
                    dbc.Col((html.Div(html.H4(pickersetting_dict['services_valadd_picker_value']))), width=2, style={'text-align': 'center'}),
                ...
                dbc.Row([
                    ...
                    dbc.Col((html.Div(html.H4(pickersetting_dict['mining_emis_picker1830_value']))), width=2, style={'text-align': 'center'}),
                    dbc.Col((html.Div(dbc.Input(id='mining_emis_picker1830', type="number", bs_size="sm", value=pickersetting_dict['mining_emis_picker1830_value'], step=pickersetting_dict['mining_emis_picker1830_steps']))), width=2, style={"text-align": "center", "padding-top":"0.15rem"}),
                    dbc.Col((html.Div(dbc.Input(id='mining_emis_picker3150', type="number", bs_size="sm", value=pickersetting_dict['mining_emis_picker1830_value'], step=pickersetting_dict['mining_emis_picker1830_steps']))), width=2, style={"text-align": "center", "padding-top":"0.15rem"}),
                    dbc.Col((html.Div(html.H4(pickersetting_dict['mining_valadd_picker_value']))), width=2, style={'text-align': 'center'}),
                ...
                dbc.Row([
                    ...
                    dbc.Col((html.Div(html.H4(pickersetting_dict['manufacturing_emis_picker1830_value']))), width=2, style={'text-align': 'center'}),
                    dbc.Col((html.Div(dbc.Input(id='manufacturing_emis_picker1830', type="number", bs_size="sm", value=pickersetting_dict['manufacturing_emis_picker1830_value'], step=pickersetting_dict['manufacturing_emis_picker1830_steps']))), width=2, style={"text-align": "center", "padding-top":"0.15rem"}),
                    dbc.Col((html.Div(dbc.Input(id='manufacturing_emis_picker3150', type="number", bs_size="sm", value=pickersetting_dict['manufacturing_emis_picker1830_value'], step=pickersetting_dict['manufacturing_emis_picker1830_steps']))), width=2, style={"text-align": "center", "padding-top":"0.15rem"}),
                    dbc.Col((html.Div(html.H4(pickersetting_dict['manufacturing_valadd_picker_value']))), width=2, style={'text-align': 'center'}),
                ...
                dbc.Row([
                    ...
                    dbc.Col((html.Div(html.H4(pickersetting_dict['gas_water_waste_emis_picker1830_value']))), width=2, style={'text-align': 'center'}),
                    dbc.Col((html.Div(dbc.Input(id='gas_water_waste_emis_picker1830', type="number", bs_size="sm", value=pickersetting_dict['gas_water_waste_emis_picker1830_value'], step=pickersetting_dict['gas_water_waste_emis_picker1830_steps']))), width=2, style={"text-align": "center", "padding-top":"0.15rem"}),
                    dbc.Col((html.Div(dbc.Input(id='gas_water_waste_emis_picker3150', type="number", bs_size="sm", value=pickersetting_dict['gas_water_waste_emis_picker1830_value'], step=pickersetting_dict['gas_water_waste_emis_picker1830_steps']))), width=2, style={"text-align": "center", "padding-top":"0.15rem"}),
                    dbc.Col((html.Div(html.H4(pickersetting_dict['gas_water_waste_valadd_picker_value']))), width=2, style={'text-align': 'center'}),
                ...
                dbc.Row([
                    ...
                    dbc.Col((html.Div(html.H4(pickersetting_dict['construction_emis_picker1830_value']))), width=2, style={'text-align': 'center'}),
                    dbc.Col((html.Div(dbc.Input(id='construction_emis_picker1830', type="number", bs_size="sm", value=pickersetting_dict['construction_emis_picker1830_value'], step=pickersetting_dict['construction_emis_picker1830_steps']))), width=2, style={"text-align": "center", "padding-top":"0.15rem"}),
                    dbc.Col((html.Div(dbc.Input(id='construction_emis_picker3150', type="number", bs_size="sm", value=pickersetting_dict['construction_emis_picker1830_value'], step=pickersetting_dict['construction_emis_picker1830_steps']))), width=2, style={"text-align": "center", "padding-top":"0.15rem"}),
                    dbc.Col((html.Div(html.H4(pickersetting_dict['construction_valadd_picker_value']))), width=2, style={'text-align': 'center'}),
                ...
                dbc.Row([
                    ...
                    dbc.Col((html.Div(html.H4(pickersetting_dict['com_transp_emis_picker1830_value']))), width=2, style={'text-align': 'center'}),
                    dbc.Col((html.Div(dbc.Input(id='com_transp_emis_picker1830', type="number", bs_size="sm", value=pickersetting_dict['com_transp_emis_picker1830_value'], step=pickersetting_dict['com_transp_emis_picker1830_steps']))), width=2, style={"text-align": "center", "padding-top":"0.15rem"}),
                    dbc.Col((html.Div(dbc.Input(id='com_transp_emis_picker3150', type="number", bs_size="sm", value=pickersetting_dict['com_transp_emis_picker1830_value'], step=pickersetting_dict['com_transp_emis_picker1830_steps']))), width=2, style={"text-align": "center", "padding-top":"0.15rem"}),
                    dbc.Col((html.Div(html.H4(pickersetting_dict['com_transp_valadd_picker_value']))), width=2, style={'text-align': 'center'}),
                ...
                dbc.Row([
                    dbc.Col((html.Div(html.H4('Commercial transport'))), width=3),
                    dbc.Col((html.Div(html.H4(pickersetting_dict['agrifor_emis_picker1830_value']))), width=2, style={'text-align': 'center'}),
                    dbc.Col((html.Div(dbc.Input(id='agrifor_emis_picker1830', type="number", bs_size="sm", value=pickersetting_dict['agrifor_emis_picker1830_value'], step=pickersetting_dict['agrifor_emis_picker1830_steps']))), width=2, style={"text-align": "center", "padding-top":"0.15rem"}),
                    dbc.Col((html.Div(dbc.Input(id='agrifor_emis_picker3150', type="number", bs_size="sm", value=pickersetting_dict['agrifor_emis_picker1830_value'], step=pickersetting_dict['agrifor_emis_picker1830_steps']))), width=2, style={"text-align": "center", "padding-top":"0.15rem"}),
                    dbc.Col((html.Div(html.H4(pickersetting_dict['agrifor_valadd_picker_value']))), width=2, style={'text-align': 'center'}),
                ...
                dbc.Row([
                    ...
                    dbc.Col((html.Div(html.H4(pickersetting_dict['electricity_emis_picker1830_value']))), width=2, style={'text-align': 'center'}),
                    dbc.Col((html.Div(dbc.Input(id='electricity_emis_picker1830', type="number", bs_size="sm", value=pickersetting_dict['electricity_emis_picker1830_value'], step=pickersetting_dict['electricity_emis_picker1830_steps']))), width=2, style={"text-align": "center", "padding-top":"0.15rem"}),
                    dbc.Col((html.Div(dbc.Input(id='electricity_emis_picker3150', type="number", bs_size="sm", value=pickersetting_dict['electricity_emis_picker1830_value'], step=pickersetting_dict['electricity_emis_picker1830_steps']))), width=2, style={"text-align": "center", "padding-top":"0.15rem"}),
                    dbc.Col((html.Div(html.H4(pickersetting_dict['electricity_growth_picker_value']))), width=2, style={'text-align': 'center'}),
                ...
                dbc.Row([
                    ...
                    dbc.Col((html.Div(html.H4(pickersetting_dict['residential_emis_picker1830_value']))), width=2, style={'text-align': 'center'}),
                    dbc.Col((html.Div(dbc.Input(id='residential_emis_picker1830', type="number", bs_size="sm", value=pickersetting_dict['residential_emis_picker1830_value'], step=pickersetting_dict['residential_emis_picker1830_steps']))), width=2, style={"text-align": "center", "padding-top":"0.15rem"}),
                    dbc.Col((html.Div(html.H4(''))), width=4),
                ...
                dbc.Row([
                    ...
                    dbc.Col((html.Div(html.H4(pickersetting_dict['lulucf_emis_pickerbase_value']))), width=2, style={'text-align': 'center'}),
                    dbc.Col((html.Div(dbc.Input(id='lulucf_emis_pickerbase', type="number", bs_size="sm", value=pickersetting_dict['lulucf_emis_pickerbase_value'], step=pickersetting_dict['lulucf_emis_pickergrow_steps']))), width=2, style={"text-align": "center", "padding-top":"0.15rem"}),
                    dbc.Col((html.Div(html.H5(''))), width=2),
                    dbc.Col((html.Div(html.H4(pickersetting_dict['lulucf_emis_pickergrow_value']))), width=2, style={'text-align': 'center'}),
                    dbc.Col((html.Div(dbc.Input(id='lulucf_emis_pickergrow', type="number", bs_size="sm", value=pickersetting_dict['lulucf_emis_pickergrow_value'], step=pickersetting_dict['lulucf_emis_pickergrow_steps']))), width=2, style={"text-align": "center", "padding-top":"0.15rem"}),
...
@app.callback(
    ...
    [Input('agrifor_emis_picker1830', 'value'),
     Input('com_transp_emis_picker1830', 'value'),
     Input('construction_emis_picker1830', 'value'),
     Input('electricity_emis_picker1830', 'value'),
     Input('gas_water_waste_emis_picker1830', 'value'),
     Input('manufacturing_emis_picker1830', 'value'),
     Input('mining_emis_picker1830', 'value'),
     Input('residential_emis_picker1830', 'value'),
     Input('services_emis_picker1830', 'value'),
     Input('lulucf_emis_pickergrow', 'value'),
     Input('tabslist', 'value')]
    )
