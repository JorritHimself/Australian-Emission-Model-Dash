...
header  = html.Div(style=HEADER_STYLE, children=[ ### backgroundColor here is for the whole webpage
    dbc.Container([
        dbc.Row([
        ...
        ]), ### padding around the title and intro
    dbc.Container([
...
content = html.Div([
    dbc.Container([
        ...
        ], fluid=True, style=CONTENT_STYLE) ### padding around the entire app
    ])
        ...
        return html.Div([
            dbc.Container([
                ...
                dbc.Row([
                    ...
                    dbc.Col((html.Div(dbc.Input(id='services_emis_picker', type="number", bs_size="sm", value=pickersetting_dict['services_emis_picker_value'], step=pickersetting_dict['services_emis_picker_steps']))), width=1),
                    dbc.Col((html.Div(html.H4(''))), width=1),
                    dbc.Col((html.Div(dbc.Input(id='services_valadd_picker', type="number", bs_size="sm", value=pickersetting_dict['services_valadd_picker_value'], step=pickersetting_dict['services_valadd_picker_steps']))), width=1),
