...
def render_content(tab):
    if tab in statelist:
        ...
        blah = {-20: '-20',-10: '-10',0: '0',10: '10',20: '20'}
        return html.Div([
            dbc.Container([
                dbc.Row([
                ...
                ], fluid=True, style={"padding": "20px 80px 20px 80px", "position": "sticky", "top": 50, 'zIndex': 9999}), ### This is for padding aroudn the entire app: fill the entire screen, but keep padding top right bottom left at x pixels
            dbc.Container([
                dbc.Row([
