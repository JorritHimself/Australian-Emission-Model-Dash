...
header  = html.Div(style=my_header_style, children=[ ### backgroundColor here is for the whole webpage
    dbc.Container([
        ...
        dbc.Row([
            html.Div(html.H3('V0.6: this tool is still under development')),
            ],style={"color": "#D62701", }),
        dbc.Row([
        ...
        return html.Div([
            dbc.Container([
                dbc.Row([
                    ...
                    dbc.Col((html.Div(html.H4('Annaul industry emission growth'))), width=4),
                    dbc.Col((html.Div(html.H4('Industry gross added value growth'))), width=4),
                    ]),
                dbc.Row([
                ...
                dbc.Row([
                    dbc.Col((html.Div(html.H4('Sector'))), width=3),
                    dbc.Col((html.Div(html.H4('Annaul industry emission reduction'))), width=4),
                ...
                dbc.Row([
                    dbc.Col((html.Div(html.H4('Sector'))), width=3),
                    dbc.Col((html.Div(html.H4('Annaul emission reduction'))), width=4),
                ...
                dbc.Row([
                    html.Div(html.H4('Emission pathway tool concept and data compilation by Paul Wyrwoll, Jorrit Gosens, Zeba Anjum.')),
                    ]),
                dbc.Row([
